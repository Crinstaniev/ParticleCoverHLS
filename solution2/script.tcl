...
add_files -tb ParticleCoverHLS/test/test_system_hls.cxx -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
...
source "./ParticleCoverHLS/solution2/directives.tcl"
csim_design -clean
csynth_design
cosim_design
