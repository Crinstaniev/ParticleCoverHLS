...
%struct.event_s = type { %struct.environment_s, [1000 x %struct.point_s], i64 }
...
define void @apatb_system_top_ir(%struct.event_s* nocapture readonly %event, i64* %total_result) local_unnamed_addr #0 {
entry:
  %total_result_copy = alloca i64, align 512
  call fastcc void @copy_in(i64* %total_result, i64* nonnull align 512 %total_result_copy)
  call void @apatb_system_top_hw(%struct.event_s* %event, i64* %total_result_copy)
  call fastcc void @copy_out(i64* %total_result, i64* nonnull align 512 %total_result_copy)
  ret void
}
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(i64* noalias, i64* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0i64(i64* %0, i64* align 512 %1)
  ret void
}

declare void @apatb_system_top_hw(%struct.event_s*, i64*)

define void @system_top_hw_stub_wrapper(%struct.event_s*, i64*) #5 {
entry:
  call void @copy_out(i64* null, i64* %1)
  call void @system_top_hw_stub(%struct.event_s* %0, i64* %1)
  call void @copy_in(i64* null, i64* %1)
  ret void
}

declare void @system_top_hw_stub(%struct.event_s*, i64*)
