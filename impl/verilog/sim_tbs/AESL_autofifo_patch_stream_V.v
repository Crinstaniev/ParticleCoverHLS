...
module AESL_autofifo_patch_stream_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"c.system_top.autotvin_patch_stream_V.dat",
	TV_OUT	=	"impl_rtl.system_top.autotvout_patch_stream_V.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 96;
parameter ADDR_WIDTH = 32'd 12;
parameter DEPTH = 32'd 1040;
