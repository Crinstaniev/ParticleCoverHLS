<project xmlns="com.autoesl.autopilot.project" name="ParticleCoverHLS" top="system_top">
    ...
    <files xmlns="">
        ...
        <file name="ParticleCoverHLS/src/types.cpp" sc="0" tb="false" cflags="-IC:/Projects/ParticleCoverHLS/include" csimflags="-IC:/Projects/ParticleCoverHLS/include" blackbox="false"/>
        ...
        <file name="ParticleCoverHLS/src/file_reader.cpp" sc="0" tb="false" cflags="-IC:/Projects/ParticleCoverHLS/include" csimflags="-IC:/Projects/ParticleCoverHLS/include" blackbox="false"/>
    </files>
    <solutions xmlns="">
