# 1 "ParticleCoverHLS/src/debug.cxx"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ParticleCoverHLS/src/debug.cxx" 2
# 1 "C:/Projects/ParticleCoverHLS/include\\debug.h" 1



# 1 "C:/Projects/ParticleCoverHLS/include/types.h" 1



# 1 "C:/Projects/ParticleCoverHLS/include/constants.h" 1
# 5 "C:/Projects/ParticleCoverHLS/include/types.h" 2
...
# 5 "C:/Projects/ParticleCoverHLS/include\\debug.h" 2

void print_DataPointArr(PointArr_s *data_points_arr);

void print_constants();
# 2 "ParticleCoverHLS/src/debug.cxx" 2
...
# 3 "ParticleCoverHLS/src/debug.cxx" 2

void print_DataPointArr(PointArr_s *point_arr) {
  VITIS_LOOP_5_1: for (int i = 0; i < point_arr->num_points; i++) {
