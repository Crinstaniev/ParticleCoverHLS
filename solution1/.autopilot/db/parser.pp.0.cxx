# 1 "ParticleCoverHLS/src/parser.cxx"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ParticleCoverHLS/src/parser.cxx" 2
# 1 "C:/Projects/ParticleCoverHLS/include\\parser.h" 1
...
# 5 "C:/Projects/ParticleCoverHLS/include\\parser.h" 2

PointArr_s init_PointArr();

void read_points(char *file_path, PointArr_s *points_arr_out);
# 2 "ParticleCoverHLS/src/parser.cxx" 2
...
# 6 "ParticleCoverHLS/src/parser.cxx" 2
...
using std::wcstombs;
using std::wctomb;
# 7 "ParticleCoverHLS/src/parser.cxx" 2

__attribute__((sdx_kernel("dummy_top_level_function", 0))) void dummy_top_level_function(PointArr_s *point_arr_in,
                              PointArr_s *point_arr_out) {
#pragma HLS TOP name=dummy_top_level_function
# 9 "ParticleCoverHLS/src/parser.cxx"
...
# 42 "ParticleCoverHLS/src/parser.cxx"
  Point_s temp_point;

  VITIS_LOOP_44_1: while (fscanf(file, "(%d,%d,%lf,%lf)", &temp_point.layer, &temp_point.radius,
